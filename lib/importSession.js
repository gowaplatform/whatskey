...
async function importEvolutionSession(options = {}) {
    ...
    logger.info('Reiniciando a conexão na API da Plataforma...');
    try {
        ...
        logger.error(`Erro ao chamar a API para conectar: ${message}`);
        logger.warn('Você pode tentar conectar manualmente no Manager.');
    }

    logger.info('Processo finalizado! O WhatsApp com Passkey deve conectar agora na API.');
